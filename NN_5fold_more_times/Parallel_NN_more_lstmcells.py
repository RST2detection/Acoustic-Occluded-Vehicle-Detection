...
# root = 'E:\\learn_about\\close_and_away_detection\\' \
#        'occluded_vehicle_acoustic_detection-master\\NN_library\\' \
#        'parallel_cnn_lstm_sed_for_one\\middle_product\\' \
#        'without_walker_data\\exp_3_4\\datasets\\datasets_cut_4'
# root = 'E:\\learn_about\\close_and_away_detection\\occluded_vehicle_acoustic_detection-master' \
#        '\\NN_library\\code4datasets_origin\\datasets_only_new_4'
# root = 'E:\\learn_about\\close_and_away_detection\\' \
#        'occluded_vehicle_acoustic_detection-master\\' \
#        'third_exp_data_produce\\datasets_2s\\exp3_4_2s_1000_10'
# 注意dropout去掉了，CNN特征图尺寸扩大为4，fc(512,512), 添加了relu 94.75%, 但是第三类仅有58%的雅克比参数
# 注意dropout去掉了，CNN特征图尺寸扩大为5，fc(1024,1024), 添加了relu, 93.93%, 总体都在60%，但是右侧远离没有上70%
# 注意dropout去掉了，CNN特征图尺寸扩大为5，fc(512,512), 添加了relu, 94.43%， 但是第三类仅有55%的准确率。
# 注意dropout没去掉，CNN特征图尺寸扩大为5，fc(512,512), 添加了relu, 94.30%，但是第三类仅有55%的准确率。
# 使用仅复制进行扩增的数据，将dropout去掉，CNN特征尺寸为4，fc(512,512), 添加了relu, lstm 输出尺寸为122，即扩大二倍,94.02%, 雅克比最低为60.3。
# 使用仅复制进行扩增的数据，将dropout保留，CNN特征尺寸为4，fc(1024,1024), 添加了relu, lstm 输出尺寸为122，。
